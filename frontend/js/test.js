function test_model() {
  $.getJSON("https://github.com/EashaaKushwah/Anti-Phish/static/classifier.json", function(clfdata) {
    var rf = random_forest(clfdata);
    $.getJSON("https://github.com/EashaaKushwah/Anti-Phish/static/testdata.json", function(testdata) {
